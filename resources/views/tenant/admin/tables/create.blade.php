...
<body class="bg-gray-50 min-h-screen">
    ...
    <nav class="bg-white border-b border-gray-100 sticky top-0 z-20 shadow-sm">
        <div class="max-w-2xl mx-auto px-4 py-3 flex justify-between items-center">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="font-bold text-gray-800 text-sm">Nueva mesa</p>
                    <p class="text-xs text-gray-400">Agregar mesa al restaurante</p>
                </div>
            </div>
        </div>
    </nav>
    ...
    <div class="max-w-2xl mx-auto px-4 py-6">
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            ...
            <form method="POST" action="{{ route('tenant.admin.tables.store') }}" class="space-y-5">
                @csrf
